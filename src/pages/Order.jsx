...
const Order = () => {
  ...
  const validateForm = () => {
    ...
    if (quantity < 1) newErrors.quantity = "Adet 1 veya daha fazla olmalı.";
    setErrors(newErrors);
    ...
    <>
      ...
      <form className="order-container" onSubmit={handleSubmit}>
        ...
        <p className="description">
          ...
          kaplanmış, daha sonra geleneksel olarak odun ateşinde bir fırında
          yüksek sıcaklıkta pişirilen, genellikle yuvarlak, düzleştirilmiş mayalı buğday bazlı
